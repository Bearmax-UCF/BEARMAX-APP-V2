class GetAllUserFilesResponse {
  ...
  GetAllUserFilesResponse({required this.message, required this.allFiles});
  ...
  factory GetAllUserFilesResponse.fromJson(Map<String, dynamic> json) {
    ...
    return GetAllUserFilesResponse(
        message: json["message"], allFiles: allFiles);
  }
}
...
class FileBlob {
  ...
  FileBlob({required this.blobName, required this.blobUrl});

  factory FileBlob.fromJson(Map<String, dynamic> json) {
    return FileBlob(blobName: json["blobName"], blobUrl: json["blobUrl"]);
  }
}
